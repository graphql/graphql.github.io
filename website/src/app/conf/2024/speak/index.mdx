...
{<h3>GraphQL Spec</h3>}
Latest and greatest developments in the GraphQL specification, graphql.js, GraphQL over
HTTP, GraphiQL, and Composite Schemas.
...
<b className="bg-yellow-500">[Description Needed]</b>
