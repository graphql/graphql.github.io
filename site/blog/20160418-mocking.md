...
Actually, I should say mocking used to be a lot of work, because a new technology is changing the way with think of APIs: GraphQL.
...
Luckily, takes only a little more effort, because customization of mock data is really where the Apollo mocking tool shines, because can customize virtually everything about the mock data that it returns.
...
If you’ve liked this post, you might also be interested in the other posts on our Medium publication [Building Apollo](https://medium.com/apollo-stack), where Sashko Stubailo and myself write about building [Apollo](http://www.apollostack.com), a futuristic GraphQL-based data stack. We’re publishing one to two posts every week, about the stuff we’re working on and thinking about.
