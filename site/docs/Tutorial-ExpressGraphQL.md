...
The simplest way to run an GraphQL API server is to use Express, a popular web application framework for Node.js. (link to https://expressjs.com/). You will need to install two additional dependencies:
