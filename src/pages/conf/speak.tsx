    ...
    contents: (
      <dl className="my-4">
        {[
          ...
          <>
            <dt className="bold mt-2">{eventName}</dt>
            <dd>{date}</dd>
          </>
        ))}
      </dl>
    ...
    contents: (
      <dl className="my-4">
        {[
          ...
          <>
            <dt className="bold mt-2">{name}</dt>
            <dd>{detail}</dd>
          </>
        ))}
      </dl>
