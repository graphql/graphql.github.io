...
<figure className="[&_img]:aspect-square [&_img]:w-full [&_img]:object-cover [&_img]:object-bottom mx-auto max-w-2xl w-96">
  ![API Days Singapore Thumbnail][thumbnail]
</figure>
...
<div className="mx-auto max-w-2xl mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
  <figure className="mx-auto w-56">
    ![GraphQL Day stickers][graphql-day-stickers]
  </figure>
  <figure className="mx-auto w-56">
    ![At the GraphQL Booth][api-days-booth]
  </figure>
  <figure className="mx-auto w-56">
    ![API Days Singapore conference floor][api-days-hallway]
  </figure>
</div>
...
<div className="mx-auto max-w-2xl mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
  <figure className="mx-auto w-56">
    ![Akshat holding GraphQL Day 2026 badge][energy-1]
  </figure>
  <figure className="mx-auto w-56">
    ![Akshat with Marina Bay Sands background][energy-2]
  </figure>
  <figure className="mx-auto w-56">
    ![Akshat with Singapore skyline][energy-3]
  </figure>
</div>
...
<figure className="mx-auto w-96">
  ![Akshat with Michael Staib and Pascal Senn][meeting-people]
</figure>
...
<div className="mx-auto max-w-2xl mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
  <figure className="mx-auto w-56">
      ![Michael Staib presenting Closing the Loop][graphql-day-1]
  </figure>
  <figure className="mx-auto w-56">
    ![Michael Staib presenting at API Days][graphql-day-2]
  </figure>
  <figure className="mx-auto w-56">
    ![Akshat speaking on stage at API Days][graphql-day-3]
  </figure>
</div>
...
<figure className="mx-auto w-96">
  ![Networking and sharing insights at GraphQL Day][valuable-1]
</figure>
...
[thumbnail]: /img/blog/2026-05-04/Thumbnail.png
[graphql-day-stickers]: /img/blog/2026-05-04/stickers.png
[api-days-booth]: /img/blog/2026-05-04/booth.png
[api-days-hallway]: /img/blog/2026-05-04/hallway.png
[energy-1]: /img/blog/2026-05-04/energy-1.png
[energy-2]: /img/blog/2026-05-04/energy-2.png
[energy-3]: /img/blog/2026-05-04/energy-3.png
[meeting-people]: /img/blog/2026-05-04/meeting-people.png
[graphql-day-1]: /img/blog/2026-05-04/graphql-day-1.png
[graphql-day-2]: /img/blog/2026-05-04/graphql-day-2.png
[graphql-day-3]: /img/blog/2026-05-04/graphql-day-3.png
[valuable-1]: /img/blog/2026-05-04/valuable-1.png
