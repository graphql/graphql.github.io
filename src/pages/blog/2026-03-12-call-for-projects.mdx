...
The Call for Projects is part of the general [GraphQL grant program](https://graphql.org/community/foundation/community-grant/) and submissions should meet the same criteria:
...
For example, these topics have been discussed recently in the community and would be a good starting point for contributions:  
...
* Consolidate schema design guidelines on graphql.org.
