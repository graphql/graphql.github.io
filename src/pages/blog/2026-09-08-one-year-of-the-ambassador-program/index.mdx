...
One year ago, the GraphQL Foundation launched the [GraphQL Ambassador Program](https://graphql.org/blog/2025-09-08-announcing-graphql-ambassadors/) to recognize and support the people helping GraphQL communities grow around the
...
Ambassadors have helped organize and support GraphQL Day events in Singapore, Amsterdam, and Bengaluru. At GraphQL Day Singapore, Akshat helped run a GraphQL booth and later [shared what he learned](https://graphql.org/blog/2026-06-02-learning-graphql-to-representing-it-at-api-days-singapore/) from speaking with developers who were evaluating GraphQL or already facing production challenges. In Bengaluru, Raj Kumar spoke about intelligent resolvers while Rigin, Jayant, and Ayush, alongside TSC members, spent time at the booth answering questions and introducing new people to GraphQL.

GraphQL Locals also brought people together in Amsterdam, London, Hyderabad, and Philadelphia, creating space for practical questions and candid conversations. After becoming one of our first Ambassadors, Sarah teamed up with fellow Philadelphian Graham to launch Philly GraphQL. Their first meetup welcomed 29 people for an introductory talk, Q&A, and a conversation about what the new community wanted from future events. We are also looking forward to the first GraphQL Virtual meetup, which Jeff is organizing for September, and Emily’s launch of GraphQL Toronto with a casual community roundtable in October.

## Supporting the tools people use

Much of the work that keeps an open-source ecosystem healthy happens away from the stage. Ambassadors continue to build and maintain projects including GraphQL Code Generator, GraphQL Editor, Grats, Hive, GraphQL Network Inspector, Relay PostGraphile, Strawberry GraphQL, Yoga, and GraphQL Zeus.
...
Ambassadors have also contributed to the discussions that shape GraphQL itself, bringing experience from large production systems, open-source libraries, and developer education into working groups and community conversations. That mix of perspectives is one of the program's greatest strengths: people can compare how an idea works at different scales, in different languages, and for different kinds of teams.
