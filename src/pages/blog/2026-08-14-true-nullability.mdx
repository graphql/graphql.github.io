...
intervention (emulating error propagation behavior locally to maintain backwards
compatibility until the application is ready to adopt more modern error-handling
practices); the days of needing watercooler-based knowledge transfer between
