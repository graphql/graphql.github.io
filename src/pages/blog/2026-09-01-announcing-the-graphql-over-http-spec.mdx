...
`QUERY` is the perfect fit for GraphQL, and we already have [plans to support it](https://github.com/graphql/graphql-over-http/pull/411). We didn't want to postpone this initial release or rush the implementation, but it'll be in the next revision of the GraphQL over HTTP specification.
