...
includes exciting experimental features, including fragment arguments and
incremental delivery, for teams that want to help test proposal-backed GraphQL
features in production-shaped systems.
