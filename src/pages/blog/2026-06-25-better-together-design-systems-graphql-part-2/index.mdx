...
In [part 1](/blog/2026-06-24-better-together-design-systems-graphql-part-1/), we discussed the relevance of design system thinking in GraphQL schema design.  And in fact, we attached GraphQL fragments to our atomic components.  These fragment shapes were created in cross-functional workshops, ensuring the result would be sufficient for practically any future use case.
