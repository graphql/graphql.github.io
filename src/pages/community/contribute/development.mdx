...
To request adding a new project, please open [an issue is the `graphql-wg`](https://github.com/graphql/graphql-wg/issues/new) repository. Project adoption is [decided by the TSC](https://github.com/graphql/graphql-wg/blob/main/GraphQL-TSC.md#decision-making-authority).
