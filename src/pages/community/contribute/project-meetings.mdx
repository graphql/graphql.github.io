...
<Callout type="info">
  There should be only one email associated to your commit. If the CLA check fail, double check this is the case by using this command: `git show -s --format='Author: %an <%ae>%nCommitter: %cn <%ce>' HEAD`
</Callout>
