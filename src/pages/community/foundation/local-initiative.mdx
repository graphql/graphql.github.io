...
- At least one
  ...
  or [Ambassador](https://github.com/graphql/community-wg/tree/main/rfcs/ambassador-program) must be granted administrator access to the Local’s online platforms
  - This is to ensure continuity of the community, should any of the original organizers not be available anymore.
...
- These talks will be **recorded, or photographed** if recording isn’t practical or appropriate, and made freely available online.
