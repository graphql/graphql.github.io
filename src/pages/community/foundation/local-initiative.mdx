...
framework for organizing local GraphQL user groups and offers support each approved
group (hereafter, a "Local"). Here’s what you need to know to get involved:
