...
const categories: Category[] = [
  {
    ...
    icon: <FrontendIcon className="size-12 text-pri-base" />,
  },
  {
    id: "backend",
    name: "Backend",
    ...
    icon: <BackendIcon className="size-12 text-pri-base" />,
  },
  {
    id: "federation",
    name: "Federation",
    ...
    icon: <FederationIcon className="size-12 text-pri-base" />,
  },
  {
    id: "security",
    name: "Security",
    ...
    icon: <SecurityIcon className="size-12 text-pri-base" />,
  },
  {
    id: "ai",
    name: "AI",
    ...
    icon: <AIIcon className="size-12 text-pri-base" />,
  },
  {
    id: "monitoring",
    name: "Monitoring",
    ...
    icon: <MonitoringIcon className="size-12 text-pri-base" />,
  },
]
