...
const ButtonConf = ({ text, href, target, className }: Props) => {
  return (
    <button
      className={
        "transition ease-in-out no-underline inline-flex text-center bg-[--rhodamine] border-0 py-2 px-6 focus:outline-none hover:drop-shadow-md hover:scale-105 rounded text-lg" +
        (className ?? "")
      }
    >
      <a
